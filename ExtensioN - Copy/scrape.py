...
# Function to scrape title, price, discount, mrp, and rating from Amazon
def scrape_amazon_data(url):
    ...
    if response.status_code == 200:
        ...
        if deal_element:
            ...
            deal = deal_element.span.get_text().strip()
        else:
            deal = None
        ...
        return title, price, discount, mrp, rating, deal
    else:
